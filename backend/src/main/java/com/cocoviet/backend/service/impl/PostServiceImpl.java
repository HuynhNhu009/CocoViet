...
public class PostServiceImpl implements IPostService {
    ...
    @Override
    public PostDTO createPost(PostRequest postRequest, String fileName) throws IOException {
        ...
        PostEntity postEntity = PostEntity.builder()
                ...
                .postImageUrl(iFileUpload.uploadFile(postRequest.getPostImageFile(),fileName))
