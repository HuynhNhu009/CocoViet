...
//     );
//     if (!category) return; // Không làm gì nếu category không tồn tại
//     setDataEdited((prev) => {
...
//   //   setDataEdited((prev) => {
//   //     const currentCategories = prev.categoryName || [];
//   //     const updatedCategories = currentCategories.includes(category.categoryName)
//   //       ? currentCategories.filter((cat) => cat !== category.categoryName)
//   //       : [...currentCategories, category.categoryName];
//   //     return { ...prev, categoryName: updatedCategories };
//   //   });
//   // };
...
//   // const isCategoryChecked = (categoryId) => {
//   //   const category = (categories || []).find((cat) => cat.categoryId === categoryId);
//   //   console.log("check category", category, categoryId)
//   //   // if (!category) return false;
//   //   return (dataEdited.categoryName || []).includes(category.categoryName);
//   // };
