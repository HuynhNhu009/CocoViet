...
//           {errors.server && (
//             <p className="text-red-500 text-center mt-2">{errors.server}</p>
//           )}
...
function LoginForm() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl border border-gray-200">
        <h2 className="text-green-600 text-2xl font-bold text-center mb-6">
          ĐĂNG NHẬP
        </h2>
        <form onSubmit={handleSubmit}>
